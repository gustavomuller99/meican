...
class m260831_000000_add_new_workflow_type extends Migration
{
    public function up()
    {
        ...
        $this->execute("
			ALTER TABLE `meican_connection_auth` CHANGE `type` `type` ENUM('USER', 'GROUP', 'WORKFLOW', 'BLOCKCHAIN') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;
        ");
    }
