...
-- -----------------------------------------------------------------------------
-- Providers (type AGG|UPA; domain.id FK -> provider.id, so IDs must match)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Domains (id mirrors provider id — enforced by FK domain.id -> provider.id)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Services (CSP = connection service, TD = topology description)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Networks (1 per domain — version column added in m171117)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Ports — bidirectional (BI), type NSI, 4 per domain
-- vlan_range is a TEXT column on meican_port (meican_vlan_range table was dropped in m150728)
...
-- Inter-domain peering alias links (bidirectional pairs)
...
-- -----------------------------------------------------------------------------
-- Provider peerings (each direction is a separate row)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Topology synchronizer (one per domain)
-- Final columns: id, name, protocol, type, auto_apply, url, subscription_id, provider_nsa
-- -----------------------------------------------------------------------------
